(function () {
    ...
    addressCreateEditController.$inject = ['$scope', '$baseController', "$AddressesService", '$routeParams'];
    ...
    function addressCreateEditController(
        ...
        function _addressPopulateByIdSuccess(data) {  
            ...
            vm.notify(function () {
                ...
                console.log('this is the new test log:', data);
        ...
        function _createAddressSucccess(event) {
            ...
            window.location.href = "/address/index#/";  // Sending the user back to the Manage user page
        }
